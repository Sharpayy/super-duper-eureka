...
float FlyPath::GetCurrentSectionFlyDistance()
{
	//float v = 0.0f;
	//for (auto i : path)
	//{
	//	v += glm::distance(i.str_pos, i.end_pos);
	//}
	//return v;
	return glm::distance(path.at(currentPathSection).str_pos, path.at(currentPathSection).end_pos);
}
